function clickshow(butt) {
  console.log("button clicked, id "+butt);
  document.getElementById(butt).classList.toggle('hidden');
  document.getElementById(butt).nextElementSibling.classList.toggle('hidden');
  document.getElementById(butt).nextElementSibling.nextElementSibling.classList.toggle('hidden');
}
